...
.bg-blue{
  --tw-bg-opacity: 1;
  background-color: rgb(18 138 243 / var(--tw-bg-opacity, 1));
}
.bg-cyan-50{
  --tw-bg-opacity: 1;
...
.bg-primary\/5{
  background-color: rgb(122 3 3 / 0.05);
}
.bg-purple-100{
  --tw-bg-opacity: 1;
...
.bg-primary{
  --tw-bg-opacity: 1;
  background-color: rgb(122 3 3 / var(--tw-bg-opacity, 1));
}
.bg-green{
  --tw-bg-opacity: 1;
  background-color: rgb(65 160 50 / var(--tw-bg-opacity, 1));
}
.bg-gradient-to-b{
...
.from-blue{
  --tw-gradient-from: #128af3 var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(18 138 243 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.from-emerald-50{
...
.from-primary{
  --tw-gradient-from: #7a0303 var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(122 3 3 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.via-\[\#fff3e8\]{
...
.to-green{
  --tw-gradient-to: #41a032 var(--tw-gradient-to-position);
}
.to-indigo-50{
...
.to-primary{
  --tw-gradient-to: #7a0303 var(--tw-gradient-to-position);
}
.to-blue{
  --tw-gradient-to: #128af3 var(--tw-gradient-to-position);
}
.bg-clip-text{
...
.text-\[\#7a0303\]{
  --tw-text-opacity: 1;
  color: rgb(122 3 3 / var(--tw-text-opacity, 1));
}
.text-amber-400{
  --tw-text-opacity: 1;
...
.text-blue{
  --tw-text-opacity: 1;
  color: rgb(18 138 243 / var(--tw-text-opacity, 1));
}
.text-cyan-700{
  --tw-text-opacity: 1;
...
.text-green{
  --tw-text-opacity: 1;
  color: rgb(65 160 50 / var(--tw-text-opacity, 1));
}
.text-indigo-700{
  --tw-text-opacity: 1;
...
.drop-shadow-\[0_0_12px_rgba\(255\2c 255\2c 255\2c 0\.9\)\]{
  --tw-drop-shadow: drop-shadow(0 0 12px rgba(255,255,255,0.9));
  filter: var(--tw-blur) var(--tw-brightness) var(--tw-contrast) var(--tw-grayscale) var(--tw-hue-rotate) var(--tw-invert) var(--tw-saturate) var(--tw-sepia) var(--tw-drop-shadow);
}
.filter{
  filter: var(--tw-blur) var(--tw-brightness) var(--tw-contrast) var(--tw-grayscale) var(--tw-hue-rotate) var(--tw-invert) var(--tw-saturate) var(--tw-sepia) var(--tw-drop-shadow);
...
.group:hover .group-hover\:bg-\[\#7a0303\]{
  --tw-bg-opacity: 1;
  background-color: rgb(122 3 3 / var(--tw-bg-opacity, 1));
}
