...
export default function HeroSection() {
    ...
    return (
        <section className="relative min-h-screen flex flex-col bg-white">
            ...
            <div className="relative z-10 flex-shrink-0 border-t border-amber-100 backdrop-blur-3xl py-4">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-center gap-4">
                        <p className="text-base text-center font-semibold text-white">
                            <span className="text-white">Achariya Welfare Trust</span> — Serving since 2011
                        </p>
                    </div>
                </div>
            </div>
